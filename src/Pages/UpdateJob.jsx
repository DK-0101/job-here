...
const UpdateJob = () => {
  ...
  const {_id, companyName, jobTitle, companyLogo, minPrice, maxPrice, salaryType, jobLocation, postingDate, experienceLevel, skills, employmentType, description, postedBy} = useLoaderData()
    ...
    <div className="bg-[#FAFAFA] py-10 px-4 lg:px-16">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="lg:w-1/2 w-full">
                    ...
                    <input type="date" placeholder="Ex: 2024/04/19" defaultValue={postingDate} {...register("postingDate")} className="create-job-input"
                    />
                </div>
                <div className="lg:w-1/2 w-full">
